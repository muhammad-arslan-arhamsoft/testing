                ...
                <a href="#" class="cursor text-decor solution_cards_box">
                    ...
                    <div class="card solution_card">
                        ...
                        <div class="card-head d-flex align-items-center mb-3 mb-2">
                            ...
                            <p class="grey-color text-capitalize mb-0">Total Organization</p>

                        </div>

                         <strong class="blue-color total">{{$organization_count}}</strong>
                ...
                <a href="#" class="cursor text-decor solution_cards_box">
                    ...
                    <div class="card solution_card">
                        ...
                        <div class="card-head d-flex align-items-center mb-3 mb-2">
                            ...
                            <p class="grey-color text-capitalize mb-0">Total User</p>

                        </div>

                        <strong class="blue-color total">{{$user_count}}</strong>
